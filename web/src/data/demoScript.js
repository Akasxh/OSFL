// 13-beat phone demo — real taps + centered pop-outs + a recruiter-reply finale.
const REST = { x: 80, y: 90 };
const BTN = { x: 50, y: 87 };

export const BEATS = [
  { key: "boot", caption: "BOOTING YOUR LIFE KERNEL", seconds: 2.2, cursor: REST },
  { key: "connect", caption: "STEP 1 · CONNECT WHAT IS ALREADY YOU", seconds: 3.6, cursor: BTN, tap: "connect" },
  { key: "folder", caption: "STEP 2 · OSFL READS YOU → A FOLDER OF YOU", seconds: 4.2, cursor: REST },
  { key: "goal", caption: "STEP 3 · NAME THE GOAL", seconds: 3.0, cursor: BTN, tap: "goal" },
  ...
  { key: "draft", caption: "ACTS IN YOUR VOICE — ONE TAP", seconds: 3.4, cursor: BTN, tap: "draft" },
  { key: "sent", caption: "SENT ✓ — ONE SHOT FIRED", seconds: 2.6, cursor: REST },
  { key: "inbox", caption: "WATCHING THE INBOX", seconds: 2.6, cursor: REST },
  { key: "reply", caption: "A REPLY LANDS", seconds: 4.2, cursor: REST },
  { key: "shotcount", caption: "A SHOT THAT COUNTS", seconds: 3.6, cursor: REST },
];
